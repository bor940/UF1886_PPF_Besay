...
Durante la ejecución del pipeline ETL **P02_transport_data.hpl** se detectó un 
error durante la fase de carga de datos en el esquema `staging`. 
...
tabla destino. 
El problema se detectó al revisar el log de ejecución del pipeline y verificar 
que el proceso finalizó con errores. --- 
...
El flujo ETL no incluía ningún paso para: - eliminar duplicados - comprobar existencia previa en destino - aplicar estrategia de actualización 
